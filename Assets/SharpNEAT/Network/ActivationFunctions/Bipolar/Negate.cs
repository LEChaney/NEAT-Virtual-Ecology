...
namespace SharpNeat.Network
{
    ...
    /// </summary>
    public class Negate : IActivationFunction
    {
        /// <summary>
        /// Default instance provided as a public static field.
        /// </summary>
        public static readonly IActivationFunction __DefaultInstance = new Negate();
        ...
        {
            get { return "Negate function.\r\nEffective xrange->[-inf,inf] yrange[-inf,inf]"; }
        }
