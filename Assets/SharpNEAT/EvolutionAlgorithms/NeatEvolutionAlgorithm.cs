        ...
        where TGenome : class, IGenome<TGenome>
    {
        ...
        private SpecieStats[] CalcSpecieStats(out int offspringCount)
        {
            ...
            {   // Handle specific case where all genomes/species have a zero fitness. 
                ...
                for(int i=0; i<specieCount; i++) 
                {
                    ...
                    inst._targetSizeInt = (int)SharpNeat.Utility.Utilities.ProbabilisticRound(targetSizeReal, _rng);
            ...
            else
            {
                ...
                for(int i=0; i<specieCount; i++)
                {
                    ...
                    inst._targetSizeInt = (int)SharpNeat.Utility.Utilities.ProbabilisticRound(inst._targetSizeReal, _rng);
            ...
            for(int i=0; i<specieCount; i++)
            {
                ...
                int eliteSizeInt = (int)SharpNeat.Utility.Utilities.ProbabilisticRound(eliteSizeReal, _rng);
                ...
                inst._offspringAsexualCount = (int)SharpNeat.Utility.Utilities.ProbabilisticRound(offspringAsexualCountReal, _rng);
                ...
                inst._selectionSizeInt = Math.Max(1, (int)SharpNeat.Utility.Utilities.ProbabilisticRound(selectionSizeReal, _rng));
            }
        ...
        private List<TGenome> CreateOffspring(SpecieStats[] specieStatsArr, int offspringCount)
        {
            ...
            // --- Produce the required number of offspring from sexual reproduction.
                ...
                int crossSpecieMatings = nonZeroSpecieCount==1 ? 0 :
                                            (int)SharpNeat.Utility.Utilities.ProbabilisticRound(_eaParams.InterspeciesMatingProportion 
        ...
        private void SortSpecieGenomes()
        {
            ...
            for(int i=0; i<specieCount; i++)
            {
                ...
                SharpNeat.Utility.Utilities.Shuffle(_specieList[i].GenomeList, _rng);
